...
Plug 'Shougo/vimproc.vim'                                                       " async library
...
Plug 'floobits/floobits-neovim'                                                 " add floobits support
Plug 'w0rp/ale'
...
" Plug 'mhartington/nvim-typescript', { 'for': 'typescript' }                     " TypeScript autocompletion
